...
export async function startServer(options) {
  ...
  const server=http.createServer(async(req,res)=>{
    try {
      ...
      if(req.method==="GET"&&["/app.js","/anchor-layout.js","/selection.js","/markdown.js","/table.js","/vendor/marked.esm.js","/style.css","/agent.css","/history.css"].includes(url.pathname))return send(res,200,await readFile(new URL(`../web${url.pathname}`,import.meta.url),"utf8"),mime[url.pathname.slice(url.pathname.lastIndexOf("."))]);
